...
#SBATCH --job-name=bevformer_test
#SBATCH --time=0-2:30:00
#SBATCH --mem=512G
# Pfade für die Slurm-Logdateien
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/t7441/t7441-dss-0000/ge84von2/3D_Semantic_Occupancy_TruckScenes/prediction/BEVFormer/work_dirs/bevformer_small_occ/results_test/slurm_%j.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/t7441/t7441-dss-0000/ge84von2/3D_Semantic_Occupancy_TruckScenes/prediction/BEVFormer/work_dirs/bevformer_small_occ/results_test/slurm_%j.err
...
# --- Paths inside the container (relative to /code/prediction/BEVFormer) ---
CONFIG_REL="projects/configs/bevformer/bevformer_small_occ.py"
CKPT_REL="work_dirs/bevformer_small_occ/multigpu_run/epoch_2.pth"
...
srun --mpi=pmi2 --unbuffered \
     ...
     bash -c '
       ...
       echo "Starting test..."
       /opt/conda/bin/conda run -n bev-former \
         ./tools/dist_test.sh '"${CONFIG_REL}"' '"${CKPT_REL}"' 1
     '
