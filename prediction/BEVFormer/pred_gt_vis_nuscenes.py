...
COLOR_MAP = np.array([
    ...
    [139, 69, 19, 255],        # 11: driveable_surface (Saddle Brown)
    [0, 255, 255, 255],        # 12: other_flat (Cyan)
    [0, 139, 139, 255],        # 13: sidewalk (Dark Cyan)
    [178, 34, 34, 255],        # 14: terrain (Firebrick)
    [85, 107, 47, 255],        # 15: manmade (Dark Olive Green)
    [211, 211, 211, 255],      # 16: vegetation (Light Gray)
...
def voxel2points(voxel_grid, voxel_size, point_cloud_range):
    ...
    void_classes = [17, 255]  # Ignore 'free' and 'unknown'
