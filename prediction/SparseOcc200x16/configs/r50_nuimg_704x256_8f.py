...
#anno_root = '/code/prediction/SparseOcc200x16/data_info/mini/'
anno_root = '/code/prediction/SparseOcc200x16/data_info/trainval/'
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='MyTensorboardLoggerHook', interval=10, reset_flag=True)
    ]
)

# evaluation
eval_config = dict(interval=1) #total_epochs
