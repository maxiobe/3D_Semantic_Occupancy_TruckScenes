...
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/t7441/t7441-dss-0000/ge84von2/3D_Semantic_Occupancy_TruckScenes/prediction/BEVFormer/work_dirs/bevformer_small_occ/mini_run_final_sbatch_full/slurm_%j.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/t7441/t7441-dss-0000/ge84von2/3D_Semantic_Occupancy_TruckScenes/prediction/BEVFormer/work_dirs/bevformer_small_occ/mini_run_final_sbatch_full/slurm_%j.err
...
RUN_NAME="mini_run_final_sbatch_full"
