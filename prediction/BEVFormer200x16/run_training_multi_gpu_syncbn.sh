...
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/t7441/t7441-dss-0000/ge84von2/3D_Semantic_Occupancy_TruckScenes/prediction/BEVFormer/work_dirs/bevformer_small_occ/multigpu_run_short_bn_sync/slurm_%j.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/t7441/t7441-dss-0000/ge84von2/3D_Semantic_Occupancy_TruckScenes/prediction/BEVFormer/work_dirs/bevformer_small_occ/multigpu_run_short_bn_sync/slurm_%j.err
...
RUN_NAME="multigpu_run_short_bn_sync"
...
srun --ntasks=1 --gres=gpu:4 --cpus-per-task=${SLURM_CPUS_PER_TASK} \
     ...
     bash -lc '
       ...
       ./tools/dist_train.sh projects/configs/bevformer/bevformer_small_occ_bn.py 4 \
