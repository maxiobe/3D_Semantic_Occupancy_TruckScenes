...
class NuSceneOcc(NuScenesDataset):
    ...
    def get_data_info(self, index):
        ...
        input_dict = dict(
            ...
            pts_filename=info['primary_lidar_path'],
            sweeps=info['sweeps'],
            ...
            can_bus=info['imu_data'],
            frame_idx=info['frame_idx'],
            timestamp=info['timestamp'] / 1e6,
        )
        if 'occ_gt_path' in info:
            input_dict['occ_gt_path'] = info['occ_gt_path']
        lidar2ego_rotation = info['primarylidar2ego_rotation']
        lidar2ego_translation = info['primarylidar2ego_translation']
        ...
        if self.modality['use_camera']:
            ...
            for cam_type, cam_info in info['cams'].items():
                ...
                lidar2cam_r = np.linalg.inv(cam_info['sensor2primarylidar_rotation'])
                lidar2cam_t = cam_info[
                                  'sensor2primarylidar_translation'] @ lidar2cam_r.T
