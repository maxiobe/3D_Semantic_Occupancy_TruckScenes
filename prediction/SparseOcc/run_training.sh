...
#SBATCH --job-name=sparseocc-training
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/t7441/t7441-dss-0000/ge84von2/3D_Semantic_Occupancy_TruckScenes/prediction/SparseOcc/outputs/SparseOcc/sbatch_single_gpu_logs/slurm_%j.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/t7441/t7441-dss-0000/ge84von2/3D_Semantic_Occupancy_TruckScenes/prediction/SparseOcc/outputs/SparseOcc/sbatch_single_gpu_logs/slurm_%j.err
...
RUN_NAME_LOGS="sbatch_single_gpu_logs"
RUN_NAME_TRAINING="sbatch_single_gpu_training"
