...
file_path = '/home/max/Desktop/Masterarbeit/Python/GaussianFormer/data/nuscenes_cam/nuscenes_infos_train_sweeps_occ.pkl'  # <-- Make sure to use your actual file name
