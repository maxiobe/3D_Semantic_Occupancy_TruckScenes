...
#SBATCH --mem=512G
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/t7441/t7441-dss-0000/ge84von2/3D_Semantic_Occupancy_TruckScenes/GaussianFormer/out/prob/nuscenes_gs6400/run_4GPU_sbatch_a100_1/eval/%x_%j.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/t7441/t7441-dss-0000/ge84von2/3D_Semantic_Occupancy_TruckScenes/GaussianFormer/out/prob/nuscenes_gs6400/run_4GPU_sbatch_a100_1/eval/%x_%j.err
...
mkdir -p "${REPO_OUT_HOST}/prob/nuscenes_gs6400/run_4GPU_sbatch_a100_1/eval"
...
PY
        ...
        conda run -n gaussianformer python -u eval.py \
          ...
          --work-dir out/prob/nuscenes_gs6400/run_4GPU_sbatch_a100_1/eval/ \
