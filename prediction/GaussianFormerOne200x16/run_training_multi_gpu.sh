...
#SBATCH --job-name=gaussian-former-1-single-gpu
#SBATCH --time=2-0:00:00
#SBATCH --mem=128G
# Pfade für die Slurm-Logdateien 
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/t7441/t7441-dss-0000/ge84von2/3D_Semantic_Occupancy_TruckScenes/prediction/GaussianFormer/out/nuscenes_gs25600_solid/run_2GPU_sbatch_1/slurm_%j.out
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/t7441/t7441-dss-0000/ge84von2/3D_Semantic_Occupancy_TruckScenes/prediction/GaussianFormer/out/nuscenes_gs25600_solid/run_2GPU_sbatch_1/slurm_%j.err
...
srun --mpi=pmi2 --unbuffered \
	...
	# --- On-the-fly Kompilierung ---
        echo "Compiling custom CUDA ops for target architecture: 8.0 9.0"
