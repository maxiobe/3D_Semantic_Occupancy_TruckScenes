...
def save_occ(
    ...
    if not sem:
        ...
        if dataset == 'trsc':
            fov_voxels = fov_grid_coords[
            (fov_grid_coords[:, 3] >= 0) & (fov_grid_coords[:, 3] < 16)
        ]
        elif dataset == 'nusc':
            fov_voxels = fov_grid_coords[
        ...
        if dataset == 'trsc':
            colors = np.array(
                [
                    ...
                    [255,   0, 255, 255],       # 11:animal               dark pink
                    # [175,   0,  75, 255],     # other_flat           dark red
                    [139, 137, 137, 255],       # 12:traffic_sign
                    [ 75,   0,  75, 255],       # 13:other_vehicle             dard purple
                    [150, 240,  80, 255],       # 14: train              light green
                    #[230, 230, 250, 255],       #              white
                    [  0, 175,   0, 255],       # 15:background            green
